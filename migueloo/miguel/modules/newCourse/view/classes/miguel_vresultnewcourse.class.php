...
class miguel_VResultNewCourse extends miguel_VMenu 
{
    ...
    function right_block() 
    {
		...
		$div->add(agt('miguel_NewCourseCreate'));
		$div->add( html_br(2) );
		$div->add(agt('miguel_CourseName'), ' => ', $this->getViewVariable('courseName') );
		$div->add(html_br(2), agt('miguel_CourseDescription'), ' => ', $this->getViewVariable('courseDescription') );

        
        $div->add(new FormProcessor(new miguel_resultNewCourseForm(), 'resultNewCourse', Util::format_URLPath('main/index.php')));
