...
class gacl {
	 ...
	 */
	var $_caching = MIGUELBASE_CACHEABLE; 
	var $_force_cache_expire = TRUE; 
	var $_cache_dir = MIGUELBASE_CACHE_DIR;
	var $_cache_expire_time = MIGUELBASE_CACHE_TIME;
	...
	function initialize()
	{
	   $this->_db_type = Session::getContextValue('ddbbSgbd');
	   $this->_db_host = Session::getContextValue('ddbbServer');
	   $this->_db_user = Session::getContextValue('ddbbUser');
	   $this->_db_password = Session::getContextValue('ddbbPassword');
	   $this->_db_name = Session::getContextValue('ddbbMainDb');
	}
}
?>
