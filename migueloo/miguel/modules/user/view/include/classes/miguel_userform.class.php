...
class miguel_userForm extends FormContent 
{
    /**
    ...
    function form_init_elements() 
    {
        ...
        $elemT = new FEText("Apellido", FALSE, 50);
        $elemT->set_style_attribute('align', 'right');
        $this->add_element($elemT);
        
        $elemT = new FEText("Nombre de usuario", FALSE, 50);
        $elemT->set_style_attribute('align', 'right');
        $this->add_element($elemT);

        $elemP = new FEText("Correo electrónico", FALSE, 60);
