...
class miguel_CUser extends miguel_Controller
{
	...
	function processPetition() 	
	{
		...
		*/
		...
		if($bol_insert){
		  $this->setPageTitle("miguel new User Page");
		  $this->setMessage("Aquí puede dar de alta un nuevo usuario");
		...
		$this->addNavElement(Util::format_URLPath("lib/user/index.php"), "Alta de Usuario");	
	}
