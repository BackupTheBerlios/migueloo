...
class miguel_VNewInscription extends miguel_VMenu
{
    ...
    function right_block()
    {
        $ret_val = container();
            ...
            $ret_val->add(html_h2(agt('Preinscripción de usuario correcta.')));
						...
						$ret_val->add(html_a(Util::format_URLPath('newInscription/index.php'), agt('Nueva Inscripción')));
				} 
				else 
				{
						$ret_val->add($this->addForm('newInscription', 'miguel_inscriptionForm'));
				}
