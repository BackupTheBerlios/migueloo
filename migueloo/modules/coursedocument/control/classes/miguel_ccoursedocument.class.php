...
class miguel_CCourseDocument extends miguel_Controller
{
	/**
	 * This is the constructor.
	 *
	 */
	function miguel_CCourseDocument() 
	{
		$this->miguel_Controller();
		$this->setModuleName('coursedocument');
		$this->setModelClass('miguel_MCourseDocument');
		$this->setViewClass('miguel_VCourseDocument');
  ...
  /*=========================================================================
	...
	{ 
		...
		*/	
		$this->addNavElement(Util::format_URLPath('coursedocument/index.php'), 'Documentación');
		//Establecer el título de la página
		$this->setPageTitle("miguel Course Document Page");
