...
class miguel_courseDocumentForm extends miguel_FormContent
{
    /**
...
//        $this->add_hidden_element("id");
    ...
    function form() 
    {
		...
		$table->add_row($this->_showElement("Fecha del evento", '5', "fecha", 'Fecha del evento', "Fecha del evento", "left" ));
		
		$table->add_row($this->_showElement("Hora Inicio", '5', "hora_ini", 'Hora Inicio', "Hora Inicio", "left"));
		$table->add_row($this->_showElement("Hora Fin", '5', "hora_fin", 'Hora Fin', "Hora Fin", "left" ));
		$table->add_row($this->_showElement("Tipo de Evento", '6', "event", 'Tipo de Evento', "Tipo de Evento", "left" )); 
		$table->add_row($this->_showElement("Asunto", '7', "asunto_de_usuario", 'Asunto', "Asunto", "left" ));     
        $table->add_row($this->_showElement("Comentario", '8', "comentario", 'Texto', "Comentario", "left" ));     
