 ...
 */
/**
 * Define un widget para asignar el par hora:fecha usando combos.
...
class FETime extends FEBoxElement 
{
	 ...
	 * @param int minute_step value for minute drop down list
	 * @param int min_value for hour drop down list
     * @param int max_value for hour drop down list
     *
     */
