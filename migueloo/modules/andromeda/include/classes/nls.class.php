...
class NLS 
{
     ...
     * @param optional string $lang Idioma en formato xx_XX   
     *
     * @access public
     *
     */
	...
	/**
     * Compruena si el charSet está en el caché interno
     * @access private
     */
    ...
    /**
     * Comprueba si un idioma es válido, es decir, la plataforma lo reconoce.
     *
     * @param optional string Idioma en formato xx_XX
     *
    ...
    /**
     * Devuelve el literal con el nombre del idioma (en su idioma nativo).
     *
     * @param optional string Idioma en formato xx_XX
     *
     * @return string Literal del nombre
     *                 
     * @access public
     */
	...
	/**
     * Formatea una fecha según los parámetros
     *
     * @param optional string Formato (ver strftime)
	 * @param optional string La fecha en formato formato aaaa-mm-dd HH:MM:SS
     *
     * @return boolean Fecha formateada segun parámetros
     *   
	 * @see strftime()          
	 *    
     * @access public
