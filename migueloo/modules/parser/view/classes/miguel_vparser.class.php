...
class miguel_vParser extends miguel_VMenu
{
     ...
     *
	 */
    function miguel_vParser($title, $arr_commarea)
    {
    ...
    function right_block()
    {
		...
		//$elem1 = html_td('color1-bg', '', 'Col1');
        //$elem1 = html_td('color1-bg', '', $this->_getFileContent(Util::format_pathApp($this->getViewVariable('url'))));
		$frame_elem = html_frameset("100%","100%");
		$frame_elem->add(html_frame('nombre',$this->getViewVariable('url'), "yes"));
		$elem1 = html_td('color1-bg', '',$frame_elem);
