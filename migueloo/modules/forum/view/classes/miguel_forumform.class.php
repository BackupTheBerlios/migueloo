...
//		    $this->add_element($TextFrom);
		    ...
		    $this->add_element($this->_formatElem("FEText", 'Nombre', 'nombre', FALSE, 50));
		    $this->add_element($this->_formatElem("FEText", 'Descripción', 'descripcion', FALSE, 100, 60, '500px', '100px'));
		    $this->add_element($this->_formatElem("FEText", 'Título', 'titulo', FALSE, 100, 60, '500px', '100px'));
    ...
    { 			
	     //  $this->set_element_value('From', $this->getViewVariable('from'));
	       ...
	       $this->set_element_value('Título', $this->getViewVariable('titulo'));
    }
    ...
    function form() 
    {
        ...
        $table->add_row($this->_showElement('Título', '10', 'titulo', 'titulo', 'Título', 'left' ));     
