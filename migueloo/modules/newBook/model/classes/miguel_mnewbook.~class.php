...
class miguel_MNewBook extends base_Model
{
    ...
    function _insertPersonData($person,$fecha, $calle, $localidad, $provincia, $email, $pais, $cp, $telefono, $fax)
    {
    
        $ret_val = $this->Insert('persondata',
                                 'person_id, fecha, calle, localidad, provincia, email, pais, cp, telefono, fax',
                                 "$person, $fecha, $calle, $localidad, $provincia, $email, $pais, $cp, $telefono, $fax");
