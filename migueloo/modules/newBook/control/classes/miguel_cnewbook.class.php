...
class miguel_CNewBook extends miguel_Controller
{
	...
	function processPetition() 
	{
        ...
        if ($this->issetViewVariable("submit") ){
           ...
           // if ($this->issetViewVariable('profile') && $this->getViewVariable('profile') != '') {
            ...
            if($all_Ok){
	           ...
	           $this->addNavElement(Util::format_URLPath('newBook/index.php'), "Inscripción (Paso 2)");
	           $insert_ok = true;
                /* } else {
		...
		$this->addNavElement(Util::format_URLPath('newBook/index.php'), "Alta de Título Bibliográfico");
		...
		//$this->setViewClass("miguel_VAuth");
		$this->addNavElement(Util::format_URLPath('newBook/index.php'), "Alta de Título");
